...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // MainActivity의 화면 관리 매니저 --> 화면변화를 감지 :: 현재 시스템에서 서비스지원
        ...
        MainRenderer.RenderCallBack mr = new MainRenderer.RenderCallBack() {
            ...
            public void preRender() {
                ...
                if(mTouched) {
                    ...
                    randoms = random.nextInt(5);
                    Log.d(String.valueOf(randoms),"랜덤나왔습니다");
    ...
    protected void onResume() {
        ...
        // 화면 갱신시 세션설정 정보를 받아서 내 세션의 설정으로 올린다.
